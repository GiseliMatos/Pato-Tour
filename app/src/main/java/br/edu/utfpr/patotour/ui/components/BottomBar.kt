 ...
 /** Compatibilidade com a ConfiguracoesScreen da merge5e7. */
 @Composable
 fun BottomBar(
     ...
     NavigationBar(containerColor = MaterialTheme.colorScheme.surfaceContainerLow) {
         ...
         NavigationBarItem(false, onMapClick, icon = { Text("⌖", fontSize = 22.sp) }, label = { Text(stringResource(R.string.map)) })
         NavigationBarItem(settingsSelected, {}, icon = { Text("⚙", fontSize = 20.sp) }, label = { Text(stringResource(R.string.settings)) })
     }
 }
